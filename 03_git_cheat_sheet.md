...
| Git command                 | Info                                                                                                                                            |
|-----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| git init *direcotry*        | Create empty Git repo in specified directory. Run with no arguments to initialize the current direcotry as a Git repo.                          |
| git clone *repo*            | Clone repo located at *repo* onto local machine. Original reop can be located on teh local filesystem or on the remote machine via HTTP or SSH. |
...
| Git command              | Info                                                                                                       |
|--------------------------|------------------------------------------------------------------------------------------------------------|
| git branch               | List all the branches in your repo. Add a *branch* argument to create a new branch with the name *branch*. |
...
| git config --global alias. *alias-name* *git-command* | Create shortcut for a Git command. E.g. *alias.glog log --graph --oneline* will set *git glog* equivalent to *log --graph --oneline*.          |
...
| git log --grep="*pattern*"   | Search for commits with a commit mesage that matches *pattern*.                                                                                   |
...
| git log -- *file*            | Only disply commits that have the specified file.                                                                                                 |
| git log --graph --decorate   | *--graph* flag draws a text based graph of commits on left side of commit messages. *--decorate* adds names of branches or tags of commits shown. |
...
| git reset *commit*        | Move the current branch tip backward to *commit*, reset the staging area to match, but leave the working direcoty alone.                        |
| git reset --hard *commit* | Same as previous, but resets both the staging area and working directory to match. Deletes uncommitted changes, and all commits after *commit*. |
...
| Git command               | Info                                                                                                                                                           |
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| git push *remote* --force | Forces the *git push* even if it results in a non-fast-forward merge. Do not use the *--force* flag unless you are absolutly sure you know what you are doing. |
| git push *remote* --all   | Push all of your local branches to the specified remote.                                                                                                       |
| git push *remote* --tags  | Tags aren´t automatically pushed when you push a branch or use the *--all* flag. The *--tag* flag sends all of your local tags to the remote repo.             |